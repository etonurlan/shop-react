import { useGetCategoryProductsQuery } from "../store/shop/shop.api"
import { Link } from "react-router-dom"
import { getGoodId } from "../store/shop/good"
import { useDispatch } from "react-redux"

export const GoodMiniCardCategories = (props: any) => {
    const {isError, data} = useGetCategoryProductsQuery(props.id)
    ...
    return (
        <div className="grid grid-cols-5 w-[100%] mt-[20px]">
