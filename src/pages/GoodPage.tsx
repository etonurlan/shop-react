            ...
            <div>
                ...
                <ul className="grid grid-cols-3 gap-x-5 my-5 max-w-md">
                    <li className="relative">
                        ...
                        <label className="flex p-5 text-[#F6F6F7] bg-[#212123] border-none rounded-lg cursor-pointer focus:outline-none peer-checked:ring-green-500 peer-checked:ring-2 peer-checked:border-transparent" for="answer_yes">Yes</label>
                    ...
                    <li className="relative">
                        ...
                        <label className="flex p-5 text-[#F6F6F7] bg-[#212123] border-none rounded-lg cursor-pointer focus:outline-none peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" for="answer_no">No</label>
                        <div className="absolute hidden w-5 h-5 peer-checked:block top-5 right-3">
                        👎
                        </div>
                    </li>
                    ...
                    <li className="relative">
                        ...
                        <label className="flex p-5 text-[#F6F6F7] bg-[#212123] border-none rounded-lg cursor-pointer focus:outline-none peer-checked:ring-yellow-500 peer-checked:ring-2 peer-checked:border-transparent" for="answer_maybe">Maybe</label>
                        <div className="absolute hidden w-5 h-5 peer-checked:block top-5 right-3">
                        🤔
                        </div>
                    </li>
